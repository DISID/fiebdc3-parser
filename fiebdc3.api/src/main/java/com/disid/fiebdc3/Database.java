...
public class Database {
     ...
     * definido para Windows, cuyo identificador será ANSI. En caso de que 
     * dicho campo esté vacío se interpretará, por omisión, que el juego de 
     * caracteres a utilizar será el 850 por compatibilidad con versiones anteriores.
     */
     ...
     * número certificación. Solo tiene sentido cuando el tipo de información 
     * es Certificación. La fecha se definirá con el mismo formato que el campo 
     ...
     * @param code of the {@link Concept}
     * @return the concept with the given code
     */
    public Concept getConcept(String code) {
        return rootConcept == null ? null : rootConcept.getConcept(code);
    }

    @Override
    public String toString() {
        return "Fiebdc3Database {"
               + "File property of: " + fileProperty +
